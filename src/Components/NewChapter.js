...
export const NewChapter = ({onChangeChapter, onChangeLesson, chapterIndex, chapterForm, setForm, form}) => {
        ...
        <form>
...

            {
                chapterForm.lessons.map((lessonForm, index)=>(
                    <NewLesson  key={index} lessonIndex={index} chapterIndex={chapterIndex} onChangeLesson={onChangeLesson} lessonForm={lessonForm} setForm={setForm} onAddLesson={handleAddLesson} />)
                )
            }           
        </form>
